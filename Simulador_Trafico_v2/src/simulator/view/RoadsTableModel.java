...
public class RoadsTableModel extends AbstractTableModel implements TrafficSimObserver{
	...
	// Atributos
		private String[] col_names = {"ID", "Length", "Weather", "Max. Speed", "Speed Limit", "Total CO2", "Distance"};
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			case 2:
				return data.get(rowIndex).getWeather().toString();
			case 3:
				return data.get(rowIndex).getMaxSpeed();
			case 4:
				return data.get(rowIndex).getSpeedLimit();
			case 5:
				return data.get(rowIndex).getTotalCO2();
			case 6:
				return data.get(rowIndex).getContLimit();
			}
			return null;
		}
